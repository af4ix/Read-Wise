...
public class ItBook3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_it_book3);
        ...
        it33 = findViewById(R.id.readIt3);
        it33.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ItBook3.this, ItPdf3.class);
